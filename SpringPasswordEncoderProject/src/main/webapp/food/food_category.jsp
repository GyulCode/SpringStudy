	...
	<div class="container-fluid">
		<div class="row">
			<div class="text-right">
				...
				<a href="../member/logout.do" class="btn btn-xs btn-info">로그아웃</a>
			</div>
		</div>
		<div class="row">
			<h3 class="text-center">푸드 카테고리</h3>
			<div class="text-center">
				...
				<button class="btn btn-sm btn-success" @click="categoryGetData(3)">메뉴별 인기 리스트</button>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-5" v-show="isShow">
				<div class="jumbotron">
