...
<body>
	<div class="container">
		<h3 class="text-center">회.원.가입</h3>
		<div class="row">
			<table class="table">
				<tr>
				...
				<tr>
					...
					<td width=80%>
						<input type="radio" value="남자"  ref="sex"  name="sex" v-model="sex">남자
						<input type=radio value="여자" ref="sex" name="sex" v-model="sex">여자
					</td>
				</tr>
				<tr>
					<td colspan=2 class="text-center">
						<input type=button value="회원가입" class="btn btn-lg btn-success" @click="join()">
		...
		<!--
		Post 방식은 params속성을 사용하여 객채형태로전달함
