		...
		<div class="col-sm6">
			<table class="table">
				<tr class="text-center">
					<td>
						<button class="btn btn-lg btn-success" v-on:click="selectMovie(1,'일별 박스오피스')">일별 박스오피스</button>
						<button class="btn btn-lg btn-info" v-on:click="selectMovie(2,'실시간 예매율')">실시간 예매율</button>
						<button class="btn btn-lg btn-warning" v-on:click="selectMovie(3,'좌석 점유율')">좌석 점유율</button>
					</td>
				</tr>
			</table>
			<table class="table">
