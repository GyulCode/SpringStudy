...
public class NewsManager {
   ...
   public List<NewsVO> newsFind(String fd)
   {
	   ...
	   String clientId = "TSGG5rcaIbXzHtumloR5"; //애플리케이션 클라이언트 아이디
       String clientSecret = "WDl4w5ZDTr"; //애플리케이션 클라이언트 시크릿
       ...
       String apiURL = "https://openapi.naver.com/v1/search/news.json?display=3&query=" + text;    // JSON 결과
