...
/*
 * 서버는 restcontroller만 있음
 * Vue,React는 이런 코딩이 아님
 * 
 */
...
public class MemberRestController {
	...
	public String member_login(String id, String pwd, boolean ck, HttpServletResponse response , HttpSession session) {
		String result="";
		int count=dao.memberIdCheck(id);
		if(count==0) {
			result="NOID";
	...
	@GetMapping(value="member/logout_ok_vue.do", produces="text/plain;charset=UTF-8")
