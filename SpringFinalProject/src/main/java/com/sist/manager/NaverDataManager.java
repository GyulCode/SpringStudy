...
public class NaverDataManager {
	...
	public List<String> jsonParser(String json){
		...
		//{....title:'제목', items:[아이템 100개...]} {}로 시작하면 Object로 받고 []로 시작하면 Arraylist로 받음 
    ...
    public String foodRecommand(String ss) {
        String clientId = "fTzO2IIdYFA_AbL9Y_HA"; //애플리케이션 클라이언트 아이디
        String clientSecret = "wkXAoabtEp"; //애플리케이션 클라이언트 시크릿
