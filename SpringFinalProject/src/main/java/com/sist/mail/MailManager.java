...
public class MailManager {
	...
	public void naverMailSend(Object obj, int type) { 
		...
		if(type==1)
	     ...
	     String user = "ldg2057@naver.com"; // 패스워드 
	     ...
	     try { 
	        	MimeMessage message = new MimeMessage(session); 
	              ...
	              message.addRecipient(Message.RecipientType.TO, new InternetAddress("ldg2057@naver.com")); // 메일 제목 
	              message.setSubject("등록된 내용입니다."); // 메일 내용
