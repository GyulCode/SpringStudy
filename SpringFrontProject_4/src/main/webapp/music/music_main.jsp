...
<script type="text/javascript" src="http://unpkg.com/bootst"></script>
	...
	<div class="container">
		...
		<div class=row>
			<div class="text-center">
				...
				<b-button variant="outline-success" @click="musicGetData(2)">가용</b-button>
		...
		<div class="row text-center">
			<input type="text" ref="fd" class=input-sm size=25 placeholder="검색어 입력" id="keyword"
		...
		<div class="row">
			<table class="table table-striped" id="user-table">
				<thead>
				<tr>
					<th class="text-center" style="width:55px">순위</th>
				...
				<tr v-for="vo in music_list">
					...
					<td class="text-center">{{vo.album}}</td>
				</tr>
				</tbody>
			</table>
		</div>	
